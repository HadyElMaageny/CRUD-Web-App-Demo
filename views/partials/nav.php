            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/"
                           class="rounded-md <?= urlIs('/') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' ?> px-3 py-2 text-sm font-medium text-white"
                        ...
                        <div>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-3">
                                        <form method="POST" action="/session">
                                            ...
                                            <button class="text-white hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">
                                                Log Out
                                            </button>
                                        </form>
                                    </div>
                            ...
                            <?php else : ?>
                                <div class="ml-3">
                                    ...
                                    <a href="/session"
                                       class="<?= urlIs('/session') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Log
                                        In</a>
                                </div>
                            <?php endif ?>
                        </div>
